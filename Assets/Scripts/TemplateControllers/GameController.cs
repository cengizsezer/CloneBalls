...
public class GameController : Singleton<GameController>
{
    ...
    public readonly UnityEvent OnGameStage2Change = new UnityEvent();
    public readonly UnityEvent OnGameStage3Change = new UnityEvent();

    public CameraController.VirtualCamera[] StageCameraList;
...
# if UNITY_EDITOR
    ...
    public virtual void Stage2Change()
    {
        OnGameStage2Change.Invoke();

    }

    public virtual void Stage3Change()
    {
        OnGameStage3Change.Invoke();
    }
